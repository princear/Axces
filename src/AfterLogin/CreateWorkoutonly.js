            ...
            <View style={{ backgroundColor: '#fff', height: hp('90%'), paddingBottom: 10, width: wp('90%'), flex: 1 }}>
              <View style={styles.head1}>
                ...
                <View style={{ width: wp('70%'), }}>
                  <Text style={{ textAlign: "center", fontFamily: 'K2D-Bold', marginTop: 10, color: '#141821', fontSize:12, }}>Choose Exercises To Add</Text>
                </View>
          ...
          <View style={styles.searchSection}>
            <View style={{ flexDirection: 'row', justifyContent:'center', alignItems:'center' }}>
              ...
              {selectedTags1 == '' ?
                ...
                >
                  <Image resizeMode="contain" style={styles.addIcon} source={require('../../Assets/Add2.png')} />
