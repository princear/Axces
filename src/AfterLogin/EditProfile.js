...
export default class EditProfile
  ...
  on_login = async () => {
    ...
    console.log('mail' + email, 'pass' + password, name, lname);
          ...
          <View style={styles.BackColor}>
            {
              this.state.choose_photo ?
                <View>
                  ...
                  >
                    <Text style={styles.pic}>Add Photo</Text>
                  </TouchableOpacity>
                </View>
                :
                <View>
                  ...
                  {/* <TouchableOpacity
 onPress={()=> this.remove_photo()}
 >
       <Text style={styles.pic}>Remove Photo</Text>
  </TouchableOpacity> */}
                </View>
            }
