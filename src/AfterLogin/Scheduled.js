...
import { scheduledworkout } from "../Redux/Actions/AllWorkoutAction";
...
class Scheduled extends Component {
  ...
  componentDidMount = async () => {
    ...
    console.log('??????????/>>>>>>>>>>>>>', this.props.Allworkouts.scheduledworkout);
    ...
    console.log("sheduledList:" + sheduledList);
    fetch(sheduledList,
      {
        method: 'POST',
        headers: new Headers({
...
<TouchableOpacity style={styles.whitebtn}
        ...
        <View style={{ height: hp('85%') }}>
          ...
          {this.props.Allworkouts.scheduledworkout ?

            <FlatList

              data={this.props.Allworkouts.scheduledworkout}
                          ...
                          {(() => {
                            if (item.workout_progress_percentage - 40 <= '0') {
                              ...
                              return (
                                <LinearGradient colors={['#1474F0', 'red',]}
                                  style={[
                                    styles.inner, { width: wp(item.workout_progress_percentage - 40), marginRight: 2, borderRadius: 50 },
                                  ]}
                          ...
                          {(() => {
                            if (item.workout_progress_percentage - 60 <= 0) {
                              ...
                              return (
                                <LinearGradient colors={['#1474F0', 'red',]}
                                  style={[
                                    styles.inner, { width: wp(item.workout_progress_percentage - 60), marginRight: 2, borderRadius: 50 },
                                  ]}
                          ...
                          {(() => {
                            if (item.workout_progress_percentage - 80 <= '0') {
                              ...
                              return (
                                <LinearGradient colors={['#1474F0', 'red',]}
                                  style={[
                                    styles.inner, { width: wp(item.workout_progress_percentage - 80), marginRight: 2, borderRadius: 50 },
                                  ]}
...
const mapStateToProps = (scheduledworkout) => {
  return {

    Allworkouts: scheduledworkout.WorkoutReducer,


  }
}

export default connect(mapStateToProps, { scheduledworkout }, null)(Scheduled);
