...
import { finishedworkout } from "../Redux/Actions/AllWorkoutAction";
...
class Finished extends Component {
  ...
  componentDidMount = async () => {
    ...
    console.log('??????????/>>>>>>>>>>>>>', this.props.Allworkouts.finishedworkout);
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <View style={{ height: hp('85%') }}>
          ...
          {this.props.Allworkouts.finishedworkout ?

            <FlatList

              data={this.props.Allworkouts.finishedworkout}
...
const mapStateToProps = (finishedworkout) => {
  return {

    Allworkouts: finishedworkout.WorkoutReducer,


  }
}

export default connect(mapStateToProps, { finishedworkout }, null)(Finished);
