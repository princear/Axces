      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView>
          ...
          <View style={{ marginTop: 20 }}>
            ...
            <Text style={{ color: '#696D76', fontFamily: 'K2D-Regular', fontSize: 12, textAlign: 'center', marginTop: Platform.OS === 'ios' ? hp(1) : 0 }}>Lorem Ipsum dolor sit amet consectetur{'\n'}adipiscing elit, sed do eiusmod tempor. </Text>
          </View>
          ...
          <View style={{ marginTop: 20 }}>
            ...
            <View style={[styles.searchSection, { marginTop: Platform.OS === 'ios' ? hp(3) : 0 }]}>
