...
export default class RegisterScreen
  ...
  on_login() {
    ...
    console.log('mail' + email, 'pass' + password, name, 'lname' + lname, 'phone' + phone);
      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView>
          ...
          <View style={{ marginTop: 20 }}>
            ...
            <View style={[styles.searchSection, { marginTop: Platform.OS === 'ios' ? hp(2) : 0 }]}>
...
const styles = StyleSheet.create({
  ...
  text2: {
    color: '#1474F0',
    fontSize: 12,
    marginTop: Platform.OS === 'ios' ? hp(3) : 5,
    paddingRight: 5,
    alignSelf: 'flex-end',
    fontFamily: 'K2D-Regular'
  },
